...
public class CompletableFutureTest {
    ...
    public void pullApproach() {
    	final ExternalService<String> externalService = new ExternalService<>("pullApproach", "ok");
    	final Future<String> future = pool.submit((Callable<String>) externalService);
    ...
    public void pushApproach() {
		...
		final CompletableFuture<String> future = CompletableFuture.supplyAsync((Supplier<String>) externalService, pool);
	...
	public void concatenateTasksUsingDelayedFunctions() throws Throwable {
		...
		CompletableFuture.supplyAsync(delayedSupplier(() -> "first")).thenCombine(other, String::concat)
				.thenApply(delayedFunction(s -> s + " | third"))
